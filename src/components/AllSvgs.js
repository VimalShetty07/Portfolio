  ...
  export const Instagram = (props) => {
    return (
        <svg
          ...
          {...props}
        >
          <path d="M12 0c6.627 0 12 5.373 12 12s-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0zm3.115 4.5h-6.23c-2.554 0-4.281 1.652-4.38 4.155l-.005.23v6.2c0 1.3.423 2.419 1.27 3.236.758.73 1.751 1.12 2.882 1.173l.263.006h6.17c1.3 0 2.389-.423 3.175-1.18.762-.733 1.182-1.757 1.234-2.947l.006-.258v-6.23c0-1.27-.423-2.359-1.21-3.145-.733-.762-1.757-1.182-2.923-1.234l-.252-.006zm-6.2 1.391h6.23c.907 0 1.663.272 2.208.817.471.499.764 1.175.81 1.96l.006.217v6.23c0 .937-.332 1.693-.877 2.208-.499.47-1.176.739-1.984.78l-.223.006h-6.17c-.907 0-1.663-.272-2.207-.786-.5-.5-.77-1.176-.811-2.008l-.006-.23v-6.2c0-.907.272-1.663.817-2.208.47-.471 1.17-.739 1.983-.78l.224-.006h6.23-6.23zM12 8.1a3.878 3.878 0 00-3.871 3.87A3.86 3.86 0 0012 15.842a3.878 3.878 0 003.871-3.871c0-2.117-1.754-3.871-3.871-3.871zm0 1.39c1.36 0 2.48 1.12 2.48 2.48 0 1.362-1.12 2.48-2.48 2.48a2.491 2.491 0 01-2.48-2.48A2.491 2.491 0 0112 9.49zm4.022-2.358a.877.877 0 100 1.754.877.877 0 000-1.754z" />
        </svg>
      )
    }
